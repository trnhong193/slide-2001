...
13. **Skip workstation specifications for Cloud deployment** - Only include Network and Camera specs
14. **Skip Power Requirements for Cloud deployment**
15. **Skip Section 8 if no custom requirements** - Only include if S2 has custom dashboard requirements or non-standard alert channels
